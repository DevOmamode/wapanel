<template>
    <div v-if="props.displayTopBar === true" class="sticky top-0 z-10 w-full bg-primary text-white border-b px-4 py-4 flex items-center justify-between md:hidden">
        <div>
    ...
    <aside
        class="transform top-0 left-0 w-[75vw] bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30"
