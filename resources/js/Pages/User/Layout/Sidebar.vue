<template>
    <aside class="md:flex flex-col h-full bg-white border-e-[1px] border-gray-200 transition-all  duration-400 ease-in-out hidden relative" :class="menuIconsOnly ? 'w-20' : 'w-80'">
...
<script setup>
    ...
    const toggleMenu = () => {
        ...
        emit('toggled', menuIconsOnly.value);
    }
</script>
