    ...
    <div class="flex-grow space-y-3 px-2 overflow-y-scroll">
        <div class="flex-1">
            <ul class="pt-2 space-y-1 text-sm mb-2">
                <div class="px-4 py-4">
                <div class="font-[500] space-x-3 text-gray-600 pb-1" :class="(menuIconsOnly ? 'hidden' : '')">MENU</div>
                <hr>
                </div>
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/dashboard') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/settings/whatsapp') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/contact') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/chats') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/campaign') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/template') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/automation') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/whatsapp/workflow') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/ecommerce') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/tools') ? 'bg-green-50 text-green-500' : ''">
                    <Link rel="noopener noreferrer" href="/tools" class="flex items-center p-2 space-x-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-tools" viewBox="0 0 24 24">
            ...
            <ul class="pb-4 space-y-1 text-sm mt-2">
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/team') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/settings') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/billing') || $page.url.startsWith('/subscription') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/support') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="user.teams[0]['role'] === 'owner'" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/developer-tools/access-tokens') ? 'bg-green-50 text-green-500' : ''">
