                ...
                <TabGroup :selectedIndex="0">
                    <TabList class="flex space-x-1 rounded-xl text-white bg-primary p-1  max-w-md ">
                        <Tab v-for="category in categories" as="template" :key="category.name" v-slot="{ selected }">
                            ...
                            <a v-if="category.name != 'Products'" :href="category.url" class="py-2.5 block">
                                {{ category.name }}
                            </a>
                    ...
                    <TabPanels class="mt-2">
                        <TabPanel v-for="category in categories">
                            <ProductsTable :rows="props.rows" :filters="props.filters"/>
                        </TabPanel>
                    </TabPanels>
                </TabGroup>
            </div>
...
<script setup>
    ...
    const props = defineProps(['rows','filters','title','catalog_id']);
