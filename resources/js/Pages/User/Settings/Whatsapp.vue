            ...
            <div class="flex justify-center items-center mb-8">
                <div class="md:w-[60em]">
                    ...
                    <div v-if="settings?.whatsapp" class="bg-white border border-slate-200 rounded-lg py-2 text-sm mb-4">
                        ...
                        <div class="grid grid-cols-4 items-center px-4 gap-x-4 py-2 border-b">
                            <div class="border-r">
                        ...
                        <div class="grid grid-cols-4 items-center text-center px-4 gap-4 py-2 mt-2">
                            <a :href="'https://business.facebook.com/latest/whatsapp_manager/404/?reason=business_access&business_id='+settings.whatsapp?.waba_id" target="_blank" class="bg-primary text-white p-2 rounded-lg text-sm">
                                {{ $t('Manage Account') }}
                            </a>
                            <a :href="'https://business.facebook.com/billing_hub/accounts?placement=standalone&account_type=whatsapp-business-account&business_id='+settings.whatsapp?.waba_id" target="_blank" class="bg-primary text-white p-2 rounded-lg text-sm">
                                {{ $t('Manage Payment') }}
                            </a>
                        </div>
                    </div>
