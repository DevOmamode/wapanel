                ...
                <div class="sm:flex border-b py-5">
                    ...
                    <div class="sm:w-[60%] sm:flex space-x-6">
                        <div class="sm:w-[80%] grid gap-x-6 gap-y-4 sm:grid-cols-6">
                            ...
                            <FormInput v-if="props.organization !== null" v-model="form.valid_until" :name="$t('Expiry Date')" :error="form.errors.valid_until" :type="'datetime-local'" :class="'sm:col-span-6'"/>
                        </div>
                    </div>
                </div>
...
<script setup>
    ...
    const form = useForm({
        ...
        valid_until: props.organization?.subscription?.valid_until,
        create_user: 1,
        first_name: null,
        last_name: null,
        email: null,
