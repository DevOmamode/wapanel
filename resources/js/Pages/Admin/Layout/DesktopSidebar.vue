<template>
    ...
    <div :class="`hidden w-full transition-all  duration-400 ease-in-out fixed top-0 left-[15.5rem] xl:left-[16.1rem] pe-[19.5rem] right-0 z-10 bg-primary text-white py-4 h-12 md:flex justify-end items-center gap-10`">
        <div class="relative">
