    ...
    <div class="flex-grow space-y-3 px-2 overflow-y-scroll">
        <div class="flex-1">
            <ul class="pt-2 space-y-1 text-sm mb-2">
                <div class="px-4 py-4">
                <div class="font-[500] space-x-3 text-gray-600 pb-1">MENU</div>
                <hr>
                </div>
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/dashboard') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/organizations') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/users') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/payment-logs') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/support') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/team/users') ? 'bg-green-50 text-green-500' : ''">
            ...
            <ul class="pb-4 space-y-1 text-sm mt-2">
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/team/roles') ? 'bg-green-50 text-green-500' : ''">
                    <Link rel="noopener noreferrer" href="/admin/team/roles" class="flex items-center p-2 space-x-3 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 20c0-1.742-1.67-3.223-4-3.773M15 20c0-2.21-2.686-4-6-4s-6 1.79-6 4m12-7a4 4 0 0 0 0-8m-6 8a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z"/></svg>
                        <span>{{ $t('Roles') }}</span>
                    </Link>
                </li>
                <li class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/plans') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/faqs') || $page.url.startsWith('/admin/subscription') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/testimonials') ? 'bg-green-50 text-green-500' : ''">
                ...
                <li v-if="props.user.email == masterAdminEmail" class="text-gray-500 hover:bg-green-50 hover:text-green-500 rounded-[5px] px-2 truncate" :class="$page.url.startsWith('/admin/settings/general') ? 'bg-green-50 text-green-500' : ''">
