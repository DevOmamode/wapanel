...
class ContactService
{
    ...
    public function store(object $request, $uuid = null){
        ...
        if (isset($request->contactLabelIds)) {
            ContactLabelMember::where('contact_id', $contact->id)->whereNotIn('contact_label_id', $request->contactLabelIds)->delete();
            foreach ($request->contactLabelIds as $key => $id) {
